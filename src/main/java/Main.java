...
//        Creating image
//        MediaItem item1 = new MediaManagement.MediaItem(name, "Image", format, 1, 50, fileLocation , resolution, false);
//        item1.CreateMediaFileBasic(item1.getFileLocation(), item1.getMediaType());
//        library.addMedia(fl, item1);
